...
def train(seed, logdir, sys_seed, k, b):
    ...
    for b in range(B):
        ...
        obscrit = GaussianObservationCriterion(1.0 * torch.ones(ydim), t[b:b + 1], y[b:b + 1])
    ...
    ceem.train(xs=x0, sys=system, nepochs=5000, smooth_solver_kwargs=smooth_solver_kwargs,
